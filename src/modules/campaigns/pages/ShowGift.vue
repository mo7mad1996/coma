<template>
  <div v-if="isDataLoaded && viewGift" class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div
    ...
    >
      ...
      <div class="mt-7 text-lg font-semibold px-6">
        <p v-if="viewGift">
          ...
          <p v-if="viewGift?.donation?.comment != null">
            <bdi>
              {{ $t('campaigns.message_gift') }}: {{ viewGift?.donation?.comment }}
...
useSeoMeta({
  description: viewGift.value.donation?.comment,
  });
